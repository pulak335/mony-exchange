        ...
        >
          ...
          <section>
            ...
            <ul className="list-disc list-inside ml-4 space-y-2">
              ...
              <li>
                <strong>Website</strong> refers to Money Exchange, accessible from <a href="/" className="text-blue-600 hover:underline">[Your Website URL]</a>
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside ml-4 space-y-1">
              ...
              <li>
                ...
                Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how You can delete Flash Cookies, please read &quot;Where can I change the settings for disabling, or deleting local shared objects?&quot; available at <a href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Adobe HelpX</a>.
              </li>
              <li>
