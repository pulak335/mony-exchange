    ...
    <div className="py-16 px-4">
      <div className="container mx-auto">
        ...
        >
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">2. Interpretation and Definitions</h2>
            ...
            <ul className="list-disc list-inside ml-4 space-y-2">
              ...
              <li>
                <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Money Exchange.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to Money Exchange, accessible from <Link href="/" className="text-blue-600 hover:underline">[Your Website URL]</Link>
              </li>
              <li>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">3. Collecting and Using Your Personal Data</h2>
            ...
            <h4 className="text-lg font-semibold text-gray-700 mb-2 mt-4">Usage Data</h4>
            <p>
            ...
            <h4 className="text-lg font-semibold text-gray-700 mb-2 mt-4">Tracking Technologies and Cookies</h4>
            <p>
            ...
            <ul className="list-disc list-inside ml-4 space-y-1">
              ...
              <li>
                <strong>Flash Cookies.</strong> Certain features of our Service may use local stored objects (or Flash Cookies) to collect and store information about Your preferences or Your activity on our Service.
                Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how You can delete Flash Cookies, please read &quot;Where can I change the settings for disabling, or deleting local shared objects?&quot; available at <Link href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Adobe HelpX</Link>.
              </li>
              <li>
                <strong>Web Beacons.</strong> Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs)
                that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Use of Your Personal Data</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Retention of Your Personal Data</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Transfer of Your Personal Data</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">7. Disclosure of Your Personal Data</h2>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2 mt-4">Law enforcement</h3>
            <p>
              Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
            </p>
            <h3 className="text-xl font-semibold text-gray-800 mb-2 mt-4">Other legal requirements</h3>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">8. Security of Your Personal Data</h2>
            <p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside ml-4">
              ...
              <li>By visiting this page on our website: <Link href="/contact" className="text-blue-600 hover:underline">/contact</Link></li>
            </ul>
          </section>
        </motion.div>
      </div>
